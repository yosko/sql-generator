...
class SqlGenerator
{
     ...
     * @param array $tables list of tables (keys are aliases, values are real table names in your DSN)
     */
    ...
    {
        // TODO define constants for join types
        $this->joins[] = array(
            'type' => $type,
            'table' => $table,
            'alias' => $alias,
    ...
    public function having(string $clause, string $name = null, $value = null, int $type = null): SqlGenerator
    {
        //TODO
    ...
    protected function buildQuery(): string
    {
        ...
        if ($this->type == self::TYPE_SELECT) {
            ...
            $sql = 'INSERT INTO ' . $this->getTable($this->table) . "\n(" . implode(', ',
                    $this->setFields) . ")\nVALUES (";
            ...
            $sql = 'DELETE FROM ' . $this->getTable($this->table);
        }
